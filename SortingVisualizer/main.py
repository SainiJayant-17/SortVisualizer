...
# l3=Label(UI_frame,text="Size of Array :",bg=WHITE)
# l3.grid(row=2,column=0,padx=10,pady=5,sticky=W)
# size_menu=ttk.Combobox(UI_frame,textvariable=size_value,values=size_list)
# size_menu.grid(row=2,column=0,padx=10,pady=5)
# speed_menu.current(0)
